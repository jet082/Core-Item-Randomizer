...
namespace CoreItemRandomizer
{
	public class HintTextData
	{
		...
		public static Dictionary<int, string> FishyLieTable = new()
		{
			...
			{ 130, "The Reaper Leviathan is the second most common lifeform on Planet 4546B. The most common is its distant relative and rival, the Peeper Leviathan." },
			{ 131, "The Reaper Leviathan is a type of highly mobile coral, known for its sharp edges and intense hue. It is said to be able to swallow prey whole, including other leviathans and even human divers." },
		...
		public static Dictionary<int, string> FishyFactTable = new()
		{
			...
			{ 10, "The lanternfish is the most common fish in the oceans' twilight zone and can be found in every ocean on the planet. It is also the prey of the sperm whale." },
